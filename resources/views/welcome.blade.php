...
<body>
    <x-navbar></x-navbar>
    <section
        class="bg-center bg-no-repeat bg-[url('https://www.pexels.com/id-id/foto/suv-genesis-gv80-yang-stylish-di-atas-bukit-dengan-suasana-minimalis-31118729/')] bg-gray-700 bg-blend-multiply">
    ...
    <section class="m-5 flex flex-col justify-center items-center gap-5">
        <div class="title text-center">
            <h1 class=" text-5xl font-bold m-5">Most Frequently Rented</h1>
        </div>
