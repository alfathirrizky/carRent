...
<body>
    ...
    <section class="bg-center bg-no-repeat bg-[url('/public/img/hero.png')] p-20">
        <div class="px-4 mx-auto max-w-screen-xl text-center py-24 lg:py-56">
            <h1
                class="mb-4 text-4xl font-extrabold tracking-tight leading-none text-white md:text-4xl lg:text-6xl sm:xl:">
                Looking to save more on
                your rental car?</h1>
            <p class="mb-8 text-lg font-normal text-gray-300 lg:text-xl sm:px-10 lg:px-48 sm:text-sm">Lorem ipsum dolor
                sit amet
                consectetur adipisicing elit. Aperiam, quidem repellendus voluptas necessitatibus perspiciatis, error
                quae minima commodi sit labore iste sed. Natus voluptatem quas
            </p>
    ...
    <section class=" flex flex-col items-center justify-center m-8 gap-6">
        ...
        <div class="flex flex-row">
            ...
            <div class="content w-40 bg-blue-900 rounded-3xl flex flex-col justify-between py-10 gap-10">
                <img class=" w-60" src="{{ url('img/inova.png') }}" alt="" srcset="">
    ...
    {{-- car list --}}
    <section class="m-5 flex flex-col items-start gap-5 flex-wrap md:flex-wrap">
        <div class="text flex flex-row justify-between">
    ...
    {{-- testimoni --}}
    <section class="p-5 m-5 my-9 bg-blue-900 rounded-lg flex flex-col gap-4">
        <div class="text">
        ...
        <div class="flex flex-row flex-wrap gap-3 md:flex-wrap">
            <div class="testimoniCard p-5 bg-white rounded-lg flex flex-col gap-10 items-center">
                <h1 class=" font-semibold text-xl">Very easy this was to integrate</h1>
                <p class=" text-xl text-center">“If you care for your time, I hands down would go with this."</p>
